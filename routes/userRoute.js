...
const { registerUser, loginUser, logoutUser, forgotPassword, resetPassword, getUserDetails,updatePassword,updateUserProfile,getAllUsers,getDetailsofUser, updateUserProfileByAdmin, deleteUserProfileByAdmin } = require("../controllers/user");
...
router.put('/admin/users/updateProfile', isAuthenticatedUser, authorizeRoles("admin"), updateUserProfileByAdmin);
router.delete('/admin/users/deleteProfile', isAuthenticatedUser, authorizeRoles("admin"), deleteUserProfileByAdmin);
